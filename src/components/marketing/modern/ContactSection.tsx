...
/**
 * Contact section — mirrors werkkompasbv.nl's contact block:
 *   - Email + phone (no postal address; site doesn't show one)
 *   - Form fields: Naam* / E-mail* / Bericht* / consent / "Stuur"
 * No invented headline, subtitle, subject field or office address.
 */
            ...
            <ul className="mt-8 space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-4 rounded-2xl bg-white/5 ring-1 ring-inset ring-white/10 p-4 transition hover:bg-white/10"
                >
