  ...
  return (
    ...
    >
      ...
      <div className="container-app relative flex-1 flex flex-col pt-28 lg:pt-32 pb-12">
        ...
        <h1
          className="font-poster mt-8 leading-[0.85] tracking-[-0.02em] -mx-2 sm:-mx-4 lg:-mx-8 break-words"
        ...
        <div className="mt-10 grid lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-6 inline-block bg-gold-400 px-4 py-3 -rotate-1 ring-4 ring-navy-900 shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
            <p className="font-poster text-2xl lg:text-3xl leading-tight text-navy-900 uppercase tracking-tight">
              {t("mk_hero_tagline")}
            </p>
          </div>
          <p className="lg:col-span-6 text-base lg:text-lg text-white/80 leading-relaxed font-semibold">
            {t("mk_hero_body")}
          </p>
        </div>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <a
            href="#contact"
            className="group inline-flex items-center gap-2 bg-gold-400 px-7 py-4 text-sm font-extrabold tracking-tight text-navy-900 uppercase ring-2 ring-navy-900 transition hover:-rotate-2 active:scale-95"
          >
          ...
          <a
            href="#diensten"
            className="inline-flex items-center gap-2 px-7 py-4 text-sm font-extrabold tracking-tight text-white uppercase ring-2 ring-white transition hover:bg-white/10"
          >
...
function StatsMaximalist() {
  ...
  return (
    <section id="cijfers" className="bg-canvas py-20 lg:py-28">
        ...
        <div className="grid sm:grid-cols-3 gap-6 lg:gap-8">
          {stats.map((s, i) => (
            <div
              key={i}
              className={cn(
                "relative p-8 lg:p-10 ring-4 ring-navy-900 shadow-[10px_10px_0_0_rgba(0,0,0,1)] transition hover:rotate-0",
                s.bg,
                s.rotate
              )}
            >
              ...
              <div className="font-poster mt-4 text-7xl lg:text-9xl leading-none tracking-tight tabular">
                {s.value}
              </div>
              <div className="mt-3 font-poster text-base lg:text-lg uppercase tracking-tight">
                {s.label}
              </div>
            </div>
          ))}
  ...
  return (
    <section id="over-ons" className="relative bg-navy-900 text-white py-20 lg:py-28 overflow-hidden">
      ...
      <div className="container-app relative">
        ...
        <h2
          className="font-poster mt-8 leading-[0.85] tracking-tight uppercase text-balance"
          style={{ fontSize: "clamp(3rem, 9vw, 8rem)" }}
        >
          {t("mk_about_title")}
        </h2>
        <div className="mt-12 grid lg:grid-cols-12 gap-8">
          <div className="lg:col-span-7 space-y-6 text-lg lg:text-xl leading-relaxed font-semibold text-white/85">
          ...
          <div className="lg:col-span-5 lg:pl-8 lg:border-l-2 lg:border-gold-400 flex flex-col justify-end">
            <a
              href="#contact"
              className="inline-flex w-fit items-center gap-2 bg-gold-400 px-7 py-4 text-sm font-extrabold tracking-tight text-navy-900 uppercase ring-2 ring-white shadow-[8px_8px_0_0_rgba(255,255,255,1)] transition hover:-rotate-2 active:scale-95"
            >
              [ {t("mk_about_cta")} ]
              <ArrowRight size={18} />
            </a>
...
function ServicesMaximalist() {
  const { t } = useT();
  const services = [
    { num: "01", titleKey: "mk_svc_1_title", bodyKey: "mk_svc_1_body", rotate: "-rotate-2", bg: "bg-gold-400 text-navy-900" },
    { num: "02", titleKey: "mk_svc_2_title", bodyKey: "mk_svc_2_body", rotate: "rotate-1", bg: "bg-canvas text-navy-900" },
    { num: "03", titleKey: "mk_svc_3_title", bodyKey: "mk_svc_3_body", rotate: "rotate-2", bg: "bg-navy-900 text-gold-400" },
    { num: "04", titleKey: "mk_svc_4_title", bodyKey: "mk_svc_4_body", rotate: "-rotate-1", bg: "bg-gold-400 text-navy-900" },
  ];
  return (
    <section id="diensten" className="relative bg-canvas py-20 lg:py-28 overflow-hidden">
      <div className="container-app">
        <span className="inline-flex items-center gap-2 bg-navy-900 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.22em] text-gold-400 ring-2 ring-navy-900">
          [ {t("mk_services_eyebrow") || "DIENSTEN"} ]
        </span>
        <h2
        ...
        <div className="mt-14 grid gap-10 lg:gap-14 sm:grid-cols-2 lg:gap-x-16">
          {services.map((s) => (
            <article
              key={s.num}
              className={cn(
            ...
            >
              <div className="font-poster text-[5rem] lg:text-[6rem] leading-none tracking-tight opacity-80">
                {s.num}
              </div>
              <h3 className="mt-6 font-poster text-2xl lg:text-3xl leading-tight tracking-tight uppercase">
                {t(s.titleKey)}
              </h3>
              <p className="mt-4 text-base lg:text-lg leading-relaxed font-semibold">
                {t(s.bodyKey)}
              </p>
            </article>
          ))}
        ...
        <div className="mt-14 grid lg:grid-cols-12 gap-8 lg:gap-12">
          <div className="lg:col-span-5 flex flex-col gap-5">
            <a
              ...
              className="flex items-center gap-4 bg-navy-900 text-gold-400 p-5 ring-4 ring-navy-900 shadow-[8px_8px_0_0_rgba(255,255,255,1)] -rotate-1 transition hover:rotate-0"
            >
              <Mail size={22} />
              <div>
                ...
                <div className="font-poster text-xl uppercase tracking-tight">
            ...
            <a
              ...
              className="flex items-center gap-4 bg-canvas text-navy-900 p-5 ring-4 ring-navy-900 shadow-[8px_8px_0_0_rgba(0,0,0,1)] rotate-1 transition hover:rotate-0"
            >
              <Phone size={22} />
              <div>
                <div className="text-[10px] font-extrabold uppercase tracking-[0.22em] opacity-65">
                ...
                <div className="font-poster text-xl tabular uppercase tracking-tight">
                  {t("mk_contact_phone_value")}
                </div>
              </div>
            </a>
          </div>
          <div className="lg:col-span-7 bg-canvas p-6 lg:p-8 ring-4 ring-navy-900 shadow-[10px_10px_0_0_rgba(0,0,0,1)]">
            {sent ? (
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-2 border-t-2 border-navy-900">
                  <span className="text-[11px] uppercase tracking-[0.22em] font-extrabold text-navy-900/70">
                  ...
                  <Button
                    ...
                    className="!rounded-none !bg-navy-900 !text-gold-400 hover:!bg-navy-800 !uppercase !tracking-tight"
                  >
                    [ {t("mk_contact_send")} ]
                    <ArrowRight size={16} />
                  </Button>
